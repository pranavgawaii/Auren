...
async function seed() {
  ...
  const demoEmails = [
    ...
    },
    {
      ...
      from_name: 'Vercel',
      subject: 'Deployment successful — tryauren.in',
      snippet: 'Your deployment to tryauren.in was successful. Build time: 43 seconds. All checks passed.',
      body: 'Your deployment to tryauren.in was successful. Build time: 43 seconds. All checks passed.',
      priority: 'fyi',
      is_read: true,
