...
export function HeroVideoDialog({
  ...
  const [internalIsVideoOpen, setInternalIsVideoOpen] = useState(false)
  const isVideoOpen = isOpen !== undefined ? isOpen : internalIsVideoOpen
  const setIsVideoOpen = setIsOpen !== undefined ? setIsOpen : setInternalIsVideoOpen
        ...
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button 
                onClick={() => setIsVideoOpen(false)}
                className="absolute -top-16 right-0 text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-md rounded-full p-2 dark:bg-neutral-100/50 dark:text-black hover:bg-neutral-800/50 transition-colors"
              >
