                      ...
                      <div className="pl-8 flex flex-col gap-2.5 mt-1 pt-2 border-t border-[rgba(36,27,20,0.04)] dark:border-[rgba(255,255,255,0.04)]">
                        {action.tool === "gmail_send" && (
                          <>
                            ...
                            {plan?.actions?.some(a => a.tool === "calendar_create" && a.parameters?.withMeetLink) && (
                              <div className="flex items-center gap-2 p-2.5 rounded-[8px] bg-[#F0FDF4] dark:bg-[#166534]/20 border border-[#16A34A]/30 text-[#16A34A] text-[11px] font-medium mt-1">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="shrink-0">
                                  <path d="M15 10L20.5 7.5V16.5L15 14M4 8H14C14.5523 8 15 8.44772 15 9V15C15 15.5523 14.5523 16 14 16H4C3.44772 16 3 15.5523 3 15V9C3 8.44772 3.44772 8 4 8Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                                <span>Google Meet URL (<code className="font-mono">meet.google.com/...</code>) will be generated by Google Calendar and injected into this email upon confirmation.</span>
                              </div>
                            )}
                          </>
                        )}
