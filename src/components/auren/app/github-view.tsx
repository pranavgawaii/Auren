        ...
        <section>
          ...
          <div className="bg-white dark:bg-[#383838] rounded-[12px] border border-[rgba(36,27,20,0.08)] dark:border-[rgba(255,255,255,0.08)] shadow-[0_2px_12px_rgba(36,27,20,0.02)] overflow-hidden">
            {isLoading ? (
              ...
              <a href={pr.html_url} target="_blank" rel="noopener noreferrer" key={pr.id} className={`p-4 flex items-start gap-4 hover:bg-[#FAF8F5] dark:bg-[#2C2C2C] transition-colors cursor-pointer block ${i !== pullRequests.length - 1 ? 'border-b border-[rgba(36,27,20,0.04)] dark:border-[rgba(255,255,255,0.04)]' : ''}`}>
                <div className="mt-1">
                  <GitPullRequest size={18} className="text-[#0F6E56]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-1">
                    <h3 className="font-sans font-medium text-[14px] text-[#241B14] dark:text-[#F4F4F5] truncate group-hover:text-[#E8593C] transition-colors">{pr.title}</h3>
                ...
                <div className="shrink-0 flex flex-col items-end gap-2">
                  <ExternalLink size={14} className="text-[rgba(36,27,20,0.3)] dark:text-[rgba(255,255,255,0.3)] group-hover:text-[rgba(36,27,20,0.6)] dark:text-[rgba(255,255,255,0.6)]" />
        ...
        <section>
          ...
          <div className="bg-white dark:bg-[#383838] rounded-[12px] border border-[rgba(36,27,20,0.08)] dark:border-[rgba(255,255,255,0.08)] shadow-[0_2px_12px_rgba(36,27,20,0.02)] overflow-hidden">
            {isLoading ? (
              ...
              <a href={issue.html_url} target="_blank" rel="noopener noreferrer" key={issue.id} className={`p-4 flex items-start gap-4 hover:bg-[#FAF8F5] dark:bg-[#2C2C2C] transition-colors cursor-pointer block group ${i !== issues.length - 1 ? 'border-b border-[rgba(36,27,20,0.04)] dark:border-[rgba(255,255,255,0.04)]' : ''}`}>
                <div className="mt-1">
                  <CircleDot size={18} className="text-[#E8593C]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-1">
                    <h3 className="font-sans font-medium text-[14px] text-[#241B14] dark:text-[#F4F4F5] truncate group-hover:text-[#E8593C] transition-colors">{issue.title}</h3>
