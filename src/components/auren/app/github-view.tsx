  ...
  if (isLoading && isConnected === null) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-[#FAF8F5] dark:bg-[#2C2C2C] p-8 text-center">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="animate-spin text-[rgba(36,27,20,0.4)] dark:text-[rgba(255,255,255,0.4)] mb-4"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
        <p className="text-[14px] text-[rgba(36,27,20,0.6)] dark:text-[rgba(255,255,255,0.6)] font-medium">Checking connection...</p>
      </div>
    );
  }
