    ...
    <div style={{ minHeight: "100vh", display: "flex" }}>
      ...
      >
        ...
        <svg aria-hidden="true" style={{
          ...
          <defs>
            <pattern id="dot-grid-signup" x="100%" y="0" width="26" height="26" patternUnits="userSpaceOnUse">
          ...
          <rect x="0" y="0" width="100%" height="100%" fill="url(#dot-grid-signup)" />
        </svg>
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-[400px]">
          ...
          <p style={{
            ...
            Type your first command in under a minute.
          </p>
        </div>
      </div>
      ...
      <div 
        ...
        style={{
          ...
          backgroundImage: "radial-gradient(circle at 50% 0%, rgba(232,89,60,0.15), transparent 60%)",
          padding: "24px"
        }}
      >
